...
const BulkInquiry = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 space-y-16">
      {/* Header */}
      <div className="text-center bg-muted/50 rounded-lg p-8 shadow-sm mb-12 animate-fade-in">
      ...
      <section className="bg-muted/50 rounded-lg p-6 shadow-sm mb-8 animate-fade-in">
      ...
      {/* Trust Signals */}
      <section className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-lg p-8 shadow-sm mb-12 animate-fade-in">
      ...
      <section className="text-center bg-muted/50 rounded-lg p-6 shadow-sm mb-8 animate-fade-in">
